...
export const metadata: Metadata = {
  title: "Terms & Conditions | PebblePlate",
  description: "Terms and Conditions for using PebblePlate. Read our policies on content use, disclaimers, and intellectual property protection.",
};
    ...
    <main id="terms-conditions-view">
      ...
      >
        ...
        <section className="space-y-4">
          ...
          <p>
            All textual descriptions, high-resolution photographs, visual recipes, structural bento elements, culinary databases, software tools, logos, and custom layout graphics shown on PebblePlate are the intellectual property of <strong>Minindu Bimsara</strong> unless otherwise explicitly credited.
          </p>
          <p>
            You are strictly forbidden from republishing complete recipes, scraping database rows, copying entire procedures, Hot-linking images, or redistributing content to other visual catalogs or print cookbooks without prior written consent. If you want to showcase our recipes on a personal portal, you may write an original paragraph and link back to the exact recipe page on PebblePlate. We deeply appreciate and support organic food community links!
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            PebblePlate grants you a non-exclusive, revocable, non-transferable licence to print, bookmark, and dynamically scale ingredients recipes for non-commercial personal kitchen use. 
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            PebblePlate participates in select culinary affiliate programmes. This means we may display curated product recommendations, baking equipment, kitchen scales, or spice kit choices that redirect you to seller platforms. We may earn a small referral commission at absolutely zero additional charge to you when you make a purchase.
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            We include links to third-party assets, such as Pinterest, Instagram, or external culinary blogs. These links are provided for your reading convenience. PebblePlate has no authority over, and accepts no direct liability for, the practices, content accuracy, or dynamic shifts of any external site.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            PebblePlate provides interactive commenting nodes, star rating controls, and recipe customizing forms. By typing, reviewing, and sending a comment, you grant PebblePlate a perpetual, non-exclusive, royalty-free, global licence to display, distribute, translate, and format your thoughts.
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            Minindu Bimsara and PebblePlate, as well as our hosts and digital creators, are not legally liable for any kitchen accidents, physical injuries, allergic reactions, raw food illnesses, oven damage, burned levain loaves, or flat souffle outcomes resulting from your use of advice written on this site. You use all recipes and guides at your own leisure and risk.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            These Terms, along with any external disputes relating to recipes and PebblePlate legal processes, shall be governed by, interpreted, and resolved in accordance with the laws of <strong>Sri Lanka</strong>, under the exclusive jurisdiction of the judicial systems in <strong>Colombo</strong>.
          </p>
        </section>
