...
export const metadata: Metadata = {
  title: "Privacy Policy | PebblePlate",
  description: "Privacy Policy for PebblePlate. Learn how we collect, use, and protect your personal information and browser cookie metrics.",
};
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <main id="privacy-policy-view">
      ...
      >
        <p>
          At <strong>PebblePlate</strong>, accessible at <a href="https://pebbleplate.page" className="hover:text-terracotta underline">https://pebbleplate.page</a>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains the types of information collected and recorded by PebblePlate and how we use it. If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.
        </p>
        ...
        <section className="space-y-4">
          ...
          <p>
            PebblePlate is dedicated to maintaining high standards of data minimisation. When you register for our weekly newsletter, request culinary customizations via our AI, or submit inquiries through the contact form, we collect information that you explicitly submit, such as your name and email address.
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            PebblePlate follows a standard procedure of using log files. These files log visitors when they navigate websites. All hosting providers perform this as a part of standard analytics tracking and modern security audits. 
          </p>
          <p>
        ...
        <section className="space-y-4 border-l-2 border-terracotta/40 pl-4 py-1">
          ...
          <p>
            Like many other modern food blogs, PebblePlate uses &apos;cookies&apos; to enrich reader experiences. These cookies store individual preferences, selected unit adjustments (such as Metric or US Customary choices), and specific pages visited by the reader. 
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            Google AdSense may deploy DART cookies to index page coordinates and serve appropriate ad placements based on your internet footprint. AdSense operates as an autonomous data collection agent in this capacity. To learn more about how Google safeguards and utilizes web parameters when you browse PebblePlate, you can read their official partner site policy guidelines at: <a href="https://policies.google.com/technologies/partner-sites" target="_blank" rel="noopener noreferrer" className="hover:text-terracotta underline">https://policies.google.com/technologies/partner-sites</a>.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            We place a high value on protecting children as they navigate online portals. PebblePlate does not knowingly collect, index, or request any personal identification variables from children under the age of 13.
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            Depending on your physical location and jurisdiction (such as CCPA in California or GDPR in the EU), you are entitled to distinct visual data protections and rights. These include options to view, update, correct, or demand the deletion of any personal parameters held by PebblePlate.
          </p>
          <p>
