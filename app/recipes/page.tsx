...
import { Search, Flame, Clock, Award, BookOpen, Layers, Sparkles, Filter, Leaf, Globe2, HelpCircle } from 'lucide-react';
...
function RecipesFallback() {
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-center p-12 space-y-4">
      ...
      <span className="font-mono text-xs text-stone-400">Loading master formulas...</span>
    </div>
  );
}
